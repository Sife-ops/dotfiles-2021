" CoC requires pynvim and npm to be installed:
...
if filereadable(expand(glob(s:plugins."/*-coc.vim")))
    ...
    " on npm: https://www.npmjs.com/search?q=keywords%3Acoc.nvim
    ...
    " Use tab or other key for trigger completion with characters ahead and navigate.
    ...
    " Use <Tab> and <S-Tab> to navigate the completion list. <- doesn't work
